    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-white/80 backdrop-blur-md shadow-sm" : "bg-transparent"}`}>
      <div className="container mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <a href="#interests" className="text-sm hover:text-primary transition-colors">Interests</a>
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 bg-white z-40 pt-20 md:hidden">
          <div className="flex flex-col items-center gap-6 p-4">
            ...
            <a href="#experience" className="text-lg hover:text-primary" onClick={toggleMenu}>Experience</a>
            ...
            <a href="#interests" className="text-lg hover:text-primary" onClick={toggleMenu}>Interests</a>
